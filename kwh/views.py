...
class addFemsTransData(APIView):
    def post(self, request):
        ...
        for i in range(len(request.data['payload'])):
            ...
            FemsTrans.objects.create(site_id=json_data1['site_id'],dev_id=json_data1['dev_id'],dev_time=json_data1['dev_time'],transaction_id=json_data1['transaction_id'],eng_type=json_data1['eng_type'],version=json_data1['version'])
